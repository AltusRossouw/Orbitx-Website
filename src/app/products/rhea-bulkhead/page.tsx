...
export default function RheaBulkheadProductPage() {
  const rhea = products.find(p => p.id === 'rhea-bulkhead')
  const image = rhea?.image || '/images/products/rhea-bulkhead-800x418.png'
  const specPdf = rhea?.pdfSpec || '/pdfs/OrbitX-Rhea-bulkhead-specifications.pdf'

  // IES files for Rhea Bulkhead
  const IES_BASE = '/products/rhea-bulkhead/docs/'
  const iesFiles: Record<string, string> = {
    '265-15-black': 'OrbitX Rhea 15W.ies',
    '265-15-white': 'OrbitX Rhea 15W.ies',
  }
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero */}
        <section id="rhea-bulkhead" className="relative py-16 md:py-20 bg-gray-900 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-orbitx-accent text-sm font-medium mb-3">INTEGRATED SURFACE MOUNT LED LIGHT</p>
                <motion.p 
                ...
                >
                  OrbitX Direct Drive Technology onboard. No metal, no rust polycarbonate housing. Available in white and black. IP54 rated with Type A light quality.
                </motion.p>
              ...
              >
                <Image src={image} alt="Rhea Bulkhead" fill className="object-contain p-6" />
              </motion.div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-10">
            <div className="space-y-6">
              ...
              <SpecCard title="Photometric Data" items={[
                ...
                'Beam Angle: 160°',
                'Stroboscopic Effect (50Hz): 80% flicker free (OHS/MHS compliant)'
              ]} />
            ...
            <div className="space-y-6">
              ...
              <SpecCard title="Additional Options" items={[
                ...
                'Variable Switching: 2 Live inputs, 1 Neutral',
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="relative rounded-xl border border-gray-800 bg-black overflow-hidden">
              <div className="relative w-full h-72 md:h-96">
                <Image
                  src="/products/rhea-bulkhead/images/rhea-bulkhead-dimensions.png"
                  alt="Rhea Bulkhead dimensions"
                  fill
            ...
            <div className="overflow-x-auto rounded-xl border border-gray-800">
              <table className="min-w-full bg-gray-900 text-sm">
                <thead className="bg-gray-800 text-gray-300">
                  <tr>
                    <th className="text-left p-3 font-semibold">Diameter (mm)</th>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="overflow-x-auto rounded-xl border border-gray-800">
              <table className="min-w-full bg-gray-900 text-sm">
                ...
                <tbody className="divide-y divide-gray-800 text-gray-300">
                  {[
                    ['OXRH265155B', 'Black', '15 W', '1', '270 × 270 × 80', '1.1', '265-15-black'],
                    ['OXRH265155W', 'White', '15 W', '1', '270 × 270 × 80', '1.1', '265-15-white'],
                  ].map((row, i) => {
...
// ---------------- Graph Components (Rhea specific) ----------------
...
function RheaSurvivalCurve() {
  const pts = [
    [0,100],[5,100],[10,100],[15,100],[20,100],[25,100],[30,100],[35,100],[40,100],[45,100],
    [50,100],[55,100],[60,100],[65,99.5],[70,98],[75,96],[80,93],[85,89],[90,84],[95,78],[100,70]
  ].map(d => ({ x: d[0], y: d[1] }))
...
function RheaLumenMaintenance() {
  const pts = [
    [0,100],[10,98],[20,96],[30,94],[40,92],[50,89],[60,85],[70,80],[75,75],[80,70],[85,65],[90,58],[95,50],[100,42]
  ].map(d => ({ x: d[0], y: d[1] }))
  const W = 520, H = 300, pad = 44
  const xMin = 0, xMax = 100, yMin = 0, yMax = 100
  const x = (v: number) => scale(v, xMin, xMax, pad, W - pad)
...
// 3) CRI vs GAI (same Type A values for Rhea)
function CRIvsGAI() {
  ...
  return (
    <svg viewBox={`0 0 ${W} ${H}`} className="w-full h-auto">
      ...
      <defs>
        <marker id="arrowBlueRhea" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto">
      ...
      {(() => {
        ...
        return (
          <>
            ...
            {/* Arrow to red ring */}
            <path d={`M ${arrowStartX},${arrowStartY} L ${arrowEndX},${arrowEndY}`} stroke="#2563eb" strokeWidth={2.5} strokeDasharray="6 6" strokeLinecap="round" fill="none" markerEnd="url(#arrowBlueRhea)" />
          </>
        )
      })()}
    </svg>
...
// 4) Spectral Power Distribution (same as Titan)
function SPDRhea() {
  const data = [
  ...
  return (
    <svg viewBox={`0 0 ${W} ${H}`} className="w-full h-auto">
      <defs>
        <linearGradient id="spdGradientRhea" x1={pad} x2={W - pad} y1={0} y2={0} gradientUnits="userSpaceOnUse">
      ...
      <path d={areaPath} fill="url(#spdGradientRhea)" opacity={0.95} />
